...
import com.achsan_18102146.prak9.databinding.ActivitySettingPreferenceBinding
import com.achsan_18102146.prak9.preferences.SettingPreference

class SettingPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    private lateinit var mSettingPreference: SettingPreference.SettingPreference
    ...
    private fun saveSetting(name: String, email: String, age: String, phoneNo: String, isDark: Boolean) {
        ...
        settingPreference.setetting(settingModel)
